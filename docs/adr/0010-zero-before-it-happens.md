...
- **その flow で一番最初の run が 1 scrape 間隔より速く終端に着くと、0 は観測されないまま 1 になる。**
  ...
  塞ぐなら TaskFlow を watch して宣言された時点で打つことになる（決定 2 で採らなかった案）。
  それを採るかどうかは、この穴の 1 回が惜しいかどうかの判断であって、配管の要不要ではない
