...
type TaskStatus struct {
	...
	//
	// Deprecated: use CurrentRuns. This field is retired once a version
	// exists that runs more than one phase at a time (ADR-0013 決定7, PR4) —
	// a shape this field cannot represent — which is the boundary a rollback
	// cannot cross, not this release.
	// +optional
